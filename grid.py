...
AI disclosure: Initial code did not contain type hints. Type hints were added by cursor.
"""
...
class Grid:
    ...
    @staticmethod
    def is_grid_within_size_limit(size: int) -> bool:
        if size < c.MIN_SIZE:
    ...
    def _is_position_within_size_limit(self, position: int) -> bool:
    ...
    def assign_position(self, player: int, x: int, y: int) -> bool:
    ...
    def _get_max_count_right(self, player: int, positions: list[Position]) -> int:
    ...
    def _get_max_count_down(self, player: int, positions: list[Position]) -> int:
    ...
    def _get_max_count_diagonal_down(self, player: int, positions: list[Position]) -> int:
    ...
    def _get_max_count_diagonal_up(self, player: int, positions: list[Position]) -> int:
    ...
    def get_max_length(self, player: int) -> int:
